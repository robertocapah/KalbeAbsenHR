...
public class tDeviceInfoUserData {
	...
	public tDeviceInfoUserData(int _intId, String _txtVersion, String _txtDevice,
							   String _txtModel, String _txtUserId, String _txtDeviceId, String _txtImei) {
		this._intId = _intId;
	...
	public synchronized String get_txtImei() {
		return _txtImei;
	}

	public synchronized void set_txtImei(String _txtImei) {
		this._txtImei = _txtImei;
	}
	...
	public String Property_txtImei="txtImeiNumber";
