...
import kalbeabsen.app.kalbenutritionals.kalbeabsen.CropDisplayPicture;
import kalbeabsen.app.kalbenutritionals.kalbeabsen.MainMenu;
import kalbeabsen.app.kalbenutritionals.kalbeabsen.R;
...
//            Toast.makeText(getActivity(), "Image load successful", Toast.LENGTH_SHORT).show();
    ...
    private void handleCropResult(CropImageView.CropResult result) {
        ...
        if (result.getError() == null) {
            ...
            List<library.salesforce.common.tDisplayPictureData> dtList = new ArrayList<>();
